...
function Opentowork() {
    ...
    return <section className="Opentowork" id="download">
        <div className=" container inner">
           ...
           <a target="_blank" href="https://drive.google.com/file/d/1lR_AIIPhjbikxhqMD6yR_BWfAXBYNlzP/view?usp=sharing"> <button className="btn  btn-md px-4 mx-2 mt-5 ">Download Resume</button></a>
